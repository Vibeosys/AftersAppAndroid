...
import com.aftersapp.activities.AttachmentImageActivity;
import com.aftersapp.adapters.BaseListAdapter;
import com.aftersapp.helper.ChatHelper;
import com.aftersapp.helper.QbUsersHolder;
import com.aftersapp.interfaces.chatinterfaces.PaginationHistoryListener;
import com.aftersapp.utils.QuickBlocsConst;
import com.aftersapp.utils.qbutils.chatutils.TimeUtils;
import com.aftersapp.views.chatviews.MaskedImageView;
    ...
    private void setMessageBody(final ViewHolder holder, QBChatMessage chatMessage) {
        if (hasAttachments(chatMessage)) {
            ...
            Glide.with(context)
                    ...
                    .override(QuickBlocsConst.PREFERRED_IMAGE_SIZE_PREVIEW, QuickBlocsConst.PREFERRED_IMAGE_SIZE_PREVIEW)
                    .dontTransform()
    ...
    private void setMessageAuthor(ViewHolder holder, QBChatMessage chatMessage) {
        if (isIncoming(chatMessage)) {
            ...
            if (hasAttachments(chatMessage)) {
                ...
                holder.messageAuthorTextView.setTextColor(context.getResources().getColor(android.R.color.white));
            } else {
                holder.messageAuthorTextView.setBackgroundResource(0);
                holder.messageAuthorTextView.setTextColor(context.getResources().getColor(R.color.warm_gray));
            }
        } else {
