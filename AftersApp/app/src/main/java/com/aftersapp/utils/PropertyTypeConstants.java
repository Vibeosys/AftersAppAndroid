...
public class PropertyTypeConstants {
    ...
    public static final String PARTY_URL = "api.endpoint.party";
    public static final String LIKE_PARTY_URL = "api.endpoint.likeparty";
    ...
    public static final String SIGN_IN_USER="api.endpoint.signin";
    ...
    public static final String USER_EMAIL2 = "user.email2";
    public static final String USER_PHONE = "user.phone";
    public static final String USER_GENDER = "user.gender";
    public static final String USER_PROF_IMG = "user.profileimg";
